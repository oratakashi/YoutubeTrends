package com.oratakashi.youtube.presentation.viewmodel.sport
...
class SportViewModel(
    ...
    fun getSport(lifecycleOwner: LifecycleOwner) : LiveData<MainState> {
        useCase.getSport().observe(lifecycleOwner, {
            when(it){
